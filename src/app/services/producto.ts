...
export class ProductoService {
  private productosMock: Producto[] = [
    ...
    { id: 18, nombre: 'Tequila Fresa', descripcion: 'Tequila con sabor a fresa', precio: 3.00, categoria: 'Copa', subcategoria: 'Chupitos' },
    { id: 19, nombre: 'Tequila', descripcion: 'Tequila', precio: 3.00, categoria: 'Copa', subcategoria: 'Chupitos' },
