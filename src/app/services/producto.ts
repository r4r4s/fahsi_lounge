...
export class ProductoService {
  ...
  private productosMock: Producto[] = [
    ...
    { id: 5, nombre: 'Ballantine’s', descripcion: 'Clásico.', precio: 8.00, categoria: 'Copa' },
    { id: 6, nombre: 'Red Label', descripcion: 'El de siempre.', precio: 8.00, categoria: 'Copa' },
    { id: 7, nombre: 'Cutty Sark', descripcion: 'Solo o con hielo.', precio: 9.00, categoria: 'Copa' },
